...
export class CoreEngine {
  ...
  constructor(options?: {
    ...
    this.logger.info('CoreEngine initialized', 'CoreEngine', { version: '3.0.0' });
  }
  ...
  private setupEventHandlers(): void {
    ...
    this.eventBus.on('request_processed', (event) => {
    ...
    this.eventBus.on('event_stored', (event) => {
    ...
    this.eventBus.on('memory_warning', (event) => {
